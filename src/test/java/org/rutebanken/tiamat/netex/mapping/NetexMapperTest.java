...
//        assertThat(netexSiteFrame.getStopPlaces().getStopPlace().getFirst().getName().getContent()).isEqualTo(stopPlace.getName().getValue());
//    }
//
//    @Test
...
//        assertThat(actualSiteFrame.getStopPlaces().getStopPlace().getFirst().getName().getValue()).isEqualTo(stopPlace.getName().getContent());
//    }
//
//    @Test
...
//
//        assertThat(netexGroupOfStopPlaces.getName().getContent())
//                .as("name.value")
