...
public class PolygonConverterTest {
    ...
    public void convertTo() throws Exception {
        ...
        Polygon polygon = polygonConverter.convertTo(polygonType, new TypeBuilder<Polygon>() {
        }.build());
    ...
    public void convertFrom() throws Exception {
        ...
        PolygonType actual = polygonConverter.convertFrom(polygon, new TypeBuilder<PolygonType>() {}.build());
