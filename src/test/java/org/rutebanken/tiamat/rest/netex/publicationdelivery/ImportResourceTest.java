...
//                .withVersion("1")
//                .withName(new MultilingualString().withContent("somewhere"))
//                .withCentroid(new SimplePoint_VersionStructure()
//                        .withLocation(new LocationStructure()
//                                .withLatitude(new BigDecimal("9"))
//                                .withLongitude(new BigDecimal("71"))));
...
//                .withVersion("1")
//                .withStopPlaceType(StopTypeEnumeration.BUS_STATION)
//                .withName(new MultilingualString().withContent("Test"))
//                .withCentroid(new SimplePoint_VersionStructure()
//                        .withLocation(new LocationStructure()
//                                .withLatitude(new BigDecimal("10"))
//                                .withLongitude(new BigDecimal("72"))));
...
//                                .withName(new MultilingualString().withContent("quay"))
//                                .withCentroid(new SimplePoint_VersionStructure()
//                                        .withLocation(new LocationStructure()
...
//         */
//        MultilingualString name = new MultilingualString().withContent("Fredheimveien").withLang("no");
//
//
...
//                .withVersion("1")
//                .withName(new MultilingualString().withContent("Skaret").withLang("no"))
//                .withQuays(new Quays_RelStructure()
//                        .withQuayRefOrQuay(new Quay()
//                                        .withVersion("1")
...
//                .withVersion("1")
//                .withName(new MultilingualString().withContent("new"))
//                .withQuays(new Quays_RelStructure()
//                        .withQuayRefOrQuay(new Quay()
//                                .withVersion("1")
//                                .withId("XYZ:Quay:5")
//                                .withName(new MultilingualString().withContent("new quay"))
//                                .withCentroid(new SimplePoint_VersionStructure().withLocation(new LocationStructure()
//                                        .withLatitude(new BigDecimal("62.799557598196465"))
//                                        .withLongitude(new BigDecimal("7.328336965528884"))))));
//
...
//                .withVersion("1")
//                .withName(new MultilingualString().withContent("Steinerskolen Moss (Buss)"))
//                .withCentroid(new SimplePoint_VersionStructure()
//                        .withLocation(new LocationStructure()
//                                .withLatitude(new BigDecimal("9"))
//                                .withLongitude(new BigDecimal("71"))))
...
//                                .withVersion("1")
//                                .withName(new MultilingualString().withContent("Steinerskolen [tog]"))
//                                .withCentroid(new SimplePoint_VersionStructure()
//                                        .withLocation(new LocationStructure()
//                                                .withLatitude(new BigDecimal("9.1"))
//                                                .withLongitude(new BigDecimal("71.2"))))));
...
//                .withVersion("1")
//                .withName(new MultilingualString().withContent("Fleskeby sentrum"))
//                .withCentroid(new SimplePoint_VersionStructure()
//                        .withLocation(new LocationStructure()
//                                .withLatitude(new BigDecimal("9"))
//                                .withLongitude(new BigDecimal("71"))))
...
//                                        .withId("XYZ:Quay:9")
//                                        .withVersion("1")
//                                        .withName(new MultilingualString().withContent("quay number one"))
//                                        .withCentroid(new SimplePoint_VersionStructure()
//                                                .withId("12")
//                                                .withVersion("1")
//                                                .withLocation(new LocationStructure()
...
//                                        .withId("XYZ:Quay:133")
//                                        .withVersion("1")
//                                        .withName(new MultilingualString().withContent("quay number two"))
//                                        .withCentroid(new SimplePoint_VersionStructure()
//                                                .withId("30")
//                                                .withVersion("1")
//                                                .withLocation(new LocationStructure()
...
//                .withVersion("1")
//                .withName(new MultilingualString().withContent("New stop1"))
