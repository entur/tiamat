...
//                .withVersion("1")
//                .withName(new MultilingualString().withContent("I don't care"))
...
//                .withStopPlaceType(StopTypeEnumeration.BUS_STATION)
//                .withVersion("1")
//                .withName(new MultilingualString().withContent("Some stop place"))
//                .withCentroid(new SimplePoint_VersionStructure()
//                        .withLocation(new LocationStructure()
...
//
//        assertThat(actualStopPlace.getName().getContent()).isNotEqualTo(tooFarAwayStopPlace.getName().getContent());
//        assertThat(actualStopPlace.getName().getContent()).isEqualTo(nearbyStopPlace.getName().getContent());
//
//    }
//
//    @Test
