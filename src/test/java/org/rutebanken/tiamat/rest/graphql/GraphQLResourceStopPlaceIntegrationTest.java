...
public class GraphQLResourceStopPlaceIntegrationTest extends AbstractGraphQLResourceIntegrationTest {
    ...
    @Test
    void addChildToParentStopPlace() {
        ...
        LOGGER.debug("tariff zones new child: ${newChild.tariffZones}");
...
//        String toDate = "2018-04-23T18:25:43.511+0200";
    ...
    void testSimpleMutationAddSecondQuay() throws Exception {
        ...
        assertThat(entityChangedJMSListener.hasReceivedEvent(stopPlace.getNetexId(), stopPlace.getVersion() + 1, EntityChangedEvent.CrudAction.UPDATE, stopPlace.getChanged().toEpochMilli())).isTrue();
    }
