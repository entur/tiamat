...
class StopPlaceDomainServiceTest {
    ...
    @BeforeEach
    void setup() {
        differ = new TiamatObjectDiffer(new GenericObjectDiffer());
    ...
    void updateStopPlace_NoDifferencesDetected_ThrowsException()
        ...
        StopPlace existingStopPlace = createStopPlace(
            stopPlaceId,
            "Test Stop",
            1L
        );
    ...
    @Test
    void updateStopPlace_IgnoresEmptyLists() throws IllegalAccessException {
        String stopPlaceId = "NSR:StopPlace:100";
        StopPlace existingStopPlace = createStopPlace(
            stopPlaceId,
            "Old stop",
        ...
        existingStopPlace.setQuays(Collections.emptySet());
        StopPlace updatedStopPlace = createStopPlace(
            stopPlaceId,
            "Old stop",
            2L
        );
        updatedStopPlace.setQuays(null);
        StopPlace savedStopPlace = createStopPlace(stopPlaceId, "Old stop", 2L);
