 ...
 * 
 * <p>Java class for SiteComponentRefStructure complex type.
 * 
...
@XmlType(name = "SiteComponentRefStructure")
@XmlSeeAlso({
    EntranceRefStructure.class,
    PointOfInterestSpaceRefStructure.class,
    ParkingAreaRefStructure.class,
