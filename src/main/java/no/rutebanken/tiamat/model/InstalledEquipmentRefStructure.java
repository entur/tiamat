 ...
 * 
 * <p>Java class for InstalledEquipmentRefStructure complex type.
 * 
...
@XmlType(name = "InstalledEquipmentRefStructure")
@XmlSeeAlso({
    PassengerInformationEquipmentRefStructure.class,
    PassengerEquipmentRefStructure.class
})
