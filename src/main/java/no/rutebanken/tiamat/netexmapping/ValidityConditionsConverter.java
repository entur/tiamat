...
public class ValidityConditionsConverter extends CustomConverter<ArrayList<no.rutebanken.tiamat.model.ValidityCondition>, ValidityConditions_RelStructure> {

    private static final Logger logger = LoggerFactory.getLogger(ValidityConditionsConverter.class);

    @Override
    public ValidityConditions_RelStructure convert(ArrayList<no.rutebanken.tiamat.model.ValidityCondition> validityConditions, Type<? extends ValidityConditions_RelStructure> type) {
