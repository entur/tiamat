...
public class SubmittedStopPlaceUpdater {

    private static final Logger logger = LoggerFactory.getLogger(SubmittedStopPlaceUpdater.class);

    private final CreateStopPlaceMapper createStopPlaceMapper;
    private final UpdateStopPlaceMapper updateStopPlaceMapper;

    public SubmittedStopPlaceUpdater(CreateStopPlaceMapper createStopPlaceMapper, UpdateStopPlaceMapper updateStopPlaceMapper) {
