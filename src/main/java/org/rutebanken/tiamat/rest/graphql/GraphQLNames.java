...
public class GraphQLNames {
    ...
    static final String OUTPUT_TYPE_PATH_LINK = "PathLink";
    static final String INPUT_TYPE_PATH_LINK = OUTPUT_TYPE_PATH_LINK + INPUT_TYPE_POSTFIX;

    static final String OUTPUT_TYPE_TRANSFER_DURATION = "TransferDuration";
    static final String INPUT_TYPE_TRANSFER_DURATION = OUTPUT_TYPE_TRANSFER_DURATION + INPUT_TYPE_POSTFIX;
    ...
    static final String FIND_PATH_LINK = "pathLink";
