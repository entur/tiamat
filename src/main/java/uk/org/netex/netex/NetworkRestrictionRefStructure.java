 ...
 * 
 * <p>Java class for NetworkRestrictionRefStructure complex type.
 * 
...
@XmlSeeAlso({
    VehicleTypeAtPointRefStructure.class,
    OvertakingPossibilityRefStructure.class,
    InfrastructureLinkRestrictionRefStructure.class
})
