...
public class SurfaceArrayPropertyType {
    ...
    protected List<JAXBElement<? extends net.opengis.gml.deprecated.AbstractSurfaceType>> abstractSurface;
     ...
     * 
     */
    public List<JAXBElement<? extends net.opengis.gml.deprecated.AbstractSurfaceType>> getAbstractSurface() {
        if (abstractSurface == null) {
            abstractSurface = new ArrayList<JAXBElement<? extends net.opengis.gml.deprecated.AbstractSurfaceType>>();
        }
