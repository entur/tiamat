...
ALTER TABLE ONLY group_of_tariff_zones_members
    ADD CONSTRAINT group_of_tariff_zones_members_pkey PRIMARY KEY (group_of_tariff_zones_id, members_id),
    ADD CONSTRAINT uk_190edtr8ue0fcp925fgjfmiq UNIQUE (members_id),
    ADD CONSTRAINT fkn7eqtat08dqjlim6wtrbd7lsm FOREIGN KEY (members_id) REFERENCES tariff_zone_ref(id),
