...
import org.rutebanken.tiamat.writer.mapper.UpdateStopPlaceMapper;
...
public class SubmittedStopPlaceUpdaterTest {
    ...
    private final SubmittedStopPlaceUpdater submittedStopPlaceUpdater = new SubmittedStopPlaceUpdater(
    ...
    public void throwsWhenEditedQuayHasNetexIdThatDoesNotExistInOriginal() {
        ...
        try {
            submittedStopPlaceUpdater.update(original, update);
    ...
    public void throwsWhenPlaceEquipmentNetexIdDoesNotMatch() {
        ...
        assertThatThrownBy(() -> submittedStopPlaceUpdater.update(original, update)).hasMessageContaining("NSR:PlaceEquipment:999")
