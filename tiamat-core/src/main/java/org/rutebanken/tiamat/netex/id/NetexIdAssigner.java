 ...
 * If the entity's NetexId is null a new ID will be generated by the ID Provider.
 * If the entity already has an ID, this will be treated as the ID is explicity claimed.
 */
